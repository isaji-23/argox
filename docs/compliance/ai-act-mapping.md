...
| **Concrete Code Paths** | • [`LocalPolicyClient`](../../argox-project/argox-core/src/argox/policies/local_client.py): Local policy check orchestration.<br>• [`RemotePolicyClient`](../../argox-project/argox-core/src/argox/policies/remote_client.py): Production-ready remote policy fetcher and in-memory evaluator.<br>• [`ArgoxManager`](../../argox-project/argox-core/src/argox/core/manager.py): Intercepts agent lifecycle phases and runs policy/processor checks. |
...
| **Concrete Code Paths** | • [`AuditLog`](../../argox-project/argox-collector/src/argox_collector/audit/log.py): Cryptographic hash chain, append-only logic, and segment management.<br>• [`verify()`](../../argox-project/argox-collector/src/argox_collector/audit/log.py#L255-L303): Walk verifier that detects gaps, sequence breaks, or content tampering.<br>• [`reconcile_run_audit` in DuckDB](../../argox-project/argox-collector/src/argox_collector/index/duckdb.py): Database reconciliation sweep for the tri-state `audited` column. |
...
| **Concrete Code Paths** | • [`PolicyCache.evaluate`](../../argox-project/argox-core/src/argox/policies/cache.py): Evaluates predicates and returns `PolicyResult.block(...)` or `PolicyResult.alert(...)`.<br>• `PoliciesScreen` (Dashboard): Monaco-based policy editor with dry-run validation. |
...
| **Concrete Code Paths** | • [`ArgoxProcessor`](../../argox-project/argox-core/src/argox/interfaces/processor.py): Base class for in-flight content processors.<br>• [`LocalPolicyClient.check_output`](../../argox-project/argox-core/src/argox/policies/local_client.py#L109-L134): Triggers output policy validation. |
...
| **Concrete Code Paths** | • [`AuditLog.append(kind="event")`](../../argox-project/argox-collector/src/argox_collector/audit/log.py#L171-L224): Appends incident entries into the WORM chain.<br>• [`attributes.py:METRIC_ARGOX_POLICY_DECISIONS`](../../argox-project/argox-core/src/argox/semconv/attributes.py#L88): Policy decision metric definition.<br>• [`Query API Router`](../../argox-project/argox-collector/src/argox_collector/routers/query.py): Query endpoint to retrieve incident records. |
